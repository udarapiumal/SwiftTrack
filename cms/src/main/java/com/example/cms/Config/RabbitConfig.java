...
public class RabbitConfig {
    ...
    public static final String ORDER_CREATED_ROS_QUEUE = "order.created.ros";  // Add this
    public static final String ORDER_CREATED_WMS_QUEUE = "order.created.wms";  // Add this
    ...
    @Bean
    public Queue orderCreatedRosQueue() {  // Add this
        return new Queue(ORDER_CREATED_ROS_QUEUE, true);
    }

    @Bean
    public Queue orderCreatedWmsQueue() {  // Add this
        return new Queue(ORDER_CREATED_WMS_QUEUE, true);
    }
