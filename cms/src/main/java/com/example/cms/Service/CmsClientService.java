...
public class CmsClientService {
    ...
    public CmsClientService(CmsSoapClient cmsSoapClient, OrderRepository orderRepository, ClientRepository clientRepository){
    ...
    public String submitOrder(String orderId, String clientId, String items){
        Client client = clientRepository.findById(clientId).orElseGet(() -> {
            ...
            newClient.setClientName("Client " + clientId); // placeholder
